...
//
float stop2X = appWidth * 1/20.8;
float stop2Y = appHeight * 1/17;
float stop2Width = appWidth * 1/20.8;
float stop2Height = appHeight * 1/17;
//
float lyricsX = appWidth * 1/20.8;
float lyricsY = appHeight * 3/17;
float lyricsWidth = appWidth * 1/20.8;
float lyricsHeight = appHeight * 1/17;
//
float aboutthesongX = appWidth * 1/20.8;
float aboutthesongY = appHeight * 5/17;
float aboutthesongWidth = appWidth * 1/20.8;
float aboutthesongHeight = appHeight * 1/17;
// 
float imageX = appWidth * 5/20.8;
float imageY = appHeight * 1/17;
float imageWidth = appWidth * 10/20.8;
float imageHeight = appHeight * 7/17;
//
float artistX = appWidth * 5/20.8;
float artistY = appHeight * 9/17;
float artistWidth = appWidth * 7/20.8;
float artistHeight = appHeight * 1/17;
//
float trackX = appWidth * 5/20.8;
float trackY = appHeight * 10.3/17;
float trackWidth = appWidth * 7/20.8;
float trackHeight = appHeight * 1/17;
//
float totaltimeX = appWidth * 5/20.8;
float totaltimeY = appHeight * 11.7/17;
float totaltimeWidth = appWidth * 7/20.8;
float totaltimeHeight = appHeight * 1/17;
//
float timeeclipseX = appWidth * 12.5/20.8;
float timeeclipseY = appHeight * 9/17;
...
//
rect(stop2X, stop2Y, stop2Width, stop2Height);
